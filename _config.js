...
var params = [];
// params["surfaces"] = ['data/surfFS.rh.graymid.surf.gii','data/atlas_MBM_cortex_vH_skeleton.R.func.gii'];
// params["surfaces"] = ['otherData/surfFS.CERB.pial_shift.surf.gii']
// params["surfaces"] = ['newData/surfFS.CERB.flatmap.surf.gii']
params["surfaces"] = ['otherData/surfFS.CERB.pial_shifti.surf(1).gii']
// params["orthogonalTall"] = true;
// params["surfaces"] = ['data/group_44_61_27_Z.R.func.gii']
switch (atlas) {
    case "vPaxinos":
        params["images"] = ['otherData/Template_sym_MTR_80um_CERB_small.nii.gz', 'otherData/change_sub_all_gradient1.nii.gz'];
        params["atlas"] = papayaLoadableImages[1].url;
        break;
    case "v4":
        params["images"] = ['otherData/Template_sym_MTR_80um_CERB_small.nii.gz', 'otherData/change_sub_all_5k_8k_gradient1.nii.gz'];
...
/** 试一下把rgb归一化 */
// params['luts'][0].data = params['luts'][0].data.map(([pctg, r, g, b])=>{
//     return [pctg, r/255,g/255,b/255]
// })

console.log(params['luts'])
...
params['change_sub_all_gradient1.nii.gz'] = {
    min:-0.1,
    max:0.1,
    lut: 'Custom1'
}
...
//     const _finishedLoad = papaya.volume.Volume.prototype.finishedLoad
//     const _this = papaya.volume.Volume.prototype
//     papaya.volume.Volume.prototype.finishedLoad = ()=>{
//         _finishedload()
...
const drawColor2Surface = () => {
    ...
    // const surfaceDataUrl = 'otherData/sub_all_gradient1_group.func.gii'
